...
class PreviewTwo extends StatefulWidget {

  const PreviewTwo({Key? key});

  @override
  State<PreviewTwo> createState() => _PreviewTwoState();
}

class _PreviewTwoState extends State<PreviewTwo> {
  ...
  FirebaseFirestore.instance.collection("Bhakt's Chat");
        ...
        actions: [
          Expanded(
            child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    padding: const EdgeInsets.only(left: 60.0, top: 17),
                    child: Text(
